...
import { ListProfileDocumentsUseCase } from '@domain/usecases/profile/ListProfileDocumentsUseCase'
...
export interface ProfileContainer {
  ...
  listProfileDocumentsUseCase: ListProfileDocumentsUseCase
...
export function createProfileContainer(supabaseClient: SupabaseClient): ProfileContainer {
  ...
  const listProfileDocumentsUseCase = new ListProfileDocumentsUseCase(documentRepository)
